        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div className="space-y-4">
            ...
            >
              <img
                src="/1000020198.jpg"
                alt="Classic Magass Logo Hoodie"
          ...
          <div className="space-y-6">
            <div>
              <h1 className="text-3xl font-bold mb-2">Classic Magass Logo Hoodie</h1>
            ...
            <p className="text-lg text-white/80">
              Premium quality hoodie featuring the iconic Magass Design logo. Crafted with attention to detail,
              this comfortable hoodie is perfect for car enthusiasts and style-conscious individuals alike.
            ...
            <div className="border-t border-white/10 pt-6">
              ...
              <ul className="list-disc list-inside space-y-2 text-white/80">
                ...
                <li>Embroidered Magass Design logo</li>
